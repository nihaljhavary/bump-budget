...
const FEATURES = [
  ...
  },
  {
    icon: 'chat',
    title: 'AI Budget Q&A',
    desc: 'Ask "Can I afford a R3 000 holiday?" and get a straight answer based on your actual numbers.',
  },
  {
    icon: 'chart',
  ...
  },
  {
    ...
    desc: '60 minutes with a human financial coach. Real advice, real plan, zero jargon.',
  },
]
...
const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    desc: 'Pick a time, pay R500 via EFT, and sit down with your coach armed with real numbers.',
  },
]
    ...
    <div className="lp">
      ...
      <nav className="lp-nav">
        ...
        <div className="lp-nav-actions">
          ...
          <Link to="/auth" className="btn-coral">Book a session</Link>
        </div>
      </nav>

      {/* HERO */}
      <section className="lp-hero">
        <span className="lp-hero-eyebrow">AI-powered budgeting &amp; expert coaching — South Africa</span>
        ...
        <div className="lp-hero-actions">
          ...
          <Link to="/auth" className="btn-ghost-lg">Book a consult</Link>
        </div>
      </section>
      ...
      <section className="lp-section">
        ...
        <h2 className="lp-section-title">R500. 60 minutes. A plan that&apos;s actually yours.</h2>
        <div className="lp-consult-wrap">
          <div className="lp-consult-card">
            <div className="lp-consult-top">
              <div>
                <p className="lp-consult-tier">60-min Expert Session</p>
                <p className="lp-consult-price">R500 <span>once-off</span></p>
                <p className="lp-consult-desc">
                  One-on-one with a certified financial coach. No scripts, no product pitches
            ...
            <div className="lp-consult-cta">
              <Link to="/auth" className="btn-coral">Book your session &rarr;</Link>
          ...
          <div className="lp-consult-side">
            ...
            <div className="lp-consult-who">
              ...
              <div>
                ...
                <p className="lp-consult-role">Founder &amp; Financial Coach, bump.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer>
        <div className="lp-footer">
          ...
          <div className="lp-footer-links">
            ...
            <a href="mailto:support@bump.money">support@bump.money</a>

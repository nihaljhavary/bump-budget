...
export default function Auth() {
  ...
  return (
    <div className="auth-wrap">
      <div className="auth-logo">bump<em>budget</em></div>
        ...
        {mode === 'sent' && (
          <div className="magic-sent">
            <div className="sent-icon">
              <svg width="22" height="22" fill="none" stroke="#1a6b45" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
